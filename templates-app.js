angular.module('templates-app', ['about/about.tpl.html', 'detail/detail.tpl.html', 'home/album.tpl.html', 'home/confirm_post.tpl.html', 'home/home.tpl.html']);
...
angular.module("home/album.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/album.tpl.html",
    "<div class=\"modal-header\">\n" +
    "  <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\" ng-click=\"cancel()\"><span aria-hidden=\"true\">&times;</span></button>\n" +
    "  <h4 class=\"modal-title\">Facebookから画像選択</h4>\n" +
    "</div>\n" +
    "<div class=\"modao-body\">\n" +
    "  <select class=\"form-control\" ng-model=\"album\" ng-options=\"a.name for a in albums\" ng-change=\"chooseAlbum(album)\">\n" +
    "    <option value=\"\">アルバムを選択</option>\n" +
    "  </select>\n" +
    "</div>\n" +
    "\n" +
    "<div class=\"row\">\n" +
    "  <div ng-repeat=\"photo in photos\" class=\"col-md-3\">\n" +
    "    <a ng-click=\"choosePhoto(photo)\" class=\"thumbnail\">\n" +
...
angular.module("home/confirm_post.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/confirm_post.tpl.html",
    "<div class=\"modal-header\">\n" +
    "  <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\" ng-click=\"cancel()\"><span aria-hidden=\"true\">&times;</span></button>\n" +
    "  <h4 class=\"modal-title\">投稿確認</h4>\n" +
    "</div>\n" +
    "\n" +
    "<div class=\"modao-body\">\n" +
    "  <div class=\"panel-body\">\n" +
